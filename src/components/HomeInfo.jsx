...
const ActionLink = ({ to, label, icon: IconComponent }) => (
  <Link to={to} className='rounded-md shadow-md p-2 shadow-cyan-600 hover:shadow-cyan-800 text-black dark:text-gray-200 flex items-center justify-center gap-2 mt-4 text-sm sm:text-base'>
    {label}
...
const STAGE_CONTENT = {
  ...
  2: {
    paragraph: "It has been a very exciting journey learning and building my skills in web and software development. Want to know more about me?",
    link: {
      to: '/about',
      label: 'Learn more...',
  ...
  4: {
    paragraph: "Get in touch with me for collaborations, projects, or just to say hi!",
    link: {
      to: '/contact',
      label: "Let's talk",
...
const HomeInfo = ({ currentStage }) => {
  ...
  const hmInfoMainDiv = "p-5 rounded-md flex flex-col items-center bg-cyan-200/50 dark:bg-gray-800/50 shadow-md shadow-cyan-600 hover:shadow-cyan-800 backdrop-blur-xs m-5 p-5 w-[600px]";
  const ptextClassName = "text-gray-800 dark:text-gray-100 text-center font-medium sm:text-lg";
